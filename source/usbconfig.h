...
#	define USB_CFG_VENDOR_NAME     'S', 't', 'e', 'p', 'h', 'a', 'n', ' ', 'B', 'a', 'e', 'r', 'w', 'o', 'l', 'f', ' ', '(', 'm','a','t', 'r', 'i', 'x','s','t', 'o', 'r', 'm','.', 'c', 'o', 'm', ')'
#endif
#ifndef USB_CFG_VENDOR_NAME_LEN
#	define USB_CFG_VENDOR_NAME_LEN 34
#endif
...
#	define USB_CFG_DEVICE_NAME     'B', 'u', 'z', 'z', 'e', 'r', 'B', 'o', 'x'
#endif
